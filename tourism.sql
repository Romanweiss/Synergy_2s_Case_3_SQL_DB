...
-- 4 таблицы-справочника + 1 таблица переменной информации
-- =====================================================
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    CONSTRAINT uq_orders_business UNIQUE (client_id, tour_id, service_id, manager_id, start_date),
...
WHERE c.phone = '+79990000001'
  ...
  AND m.phone = '+79990000003'
ON CONFLICT (client_id, tour_id, service_id, manager_id, start_date) DO NOTHING;
